...
class CreateInvoicePageAr extends StatefulWidget {
  final Map<String, dynamic>? invoiceData; // استقبال بيانات الفاتورة

  const CreateInvoicePageAr({super.key, this.invoiceData});

  @override
  State<CreateInvoicePageAr> createState() => _CreateInvoicePageArState();
}

class _CreateInvoicePageArState extends State<CreateInvoicePageAr> {
  int invoiceNumber = 1;
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('إنشاء فاتورة'), centerTitle: true),
